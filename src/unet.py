...
# At some point we could just make this the main one (testing showed that they 
# were basically the same and the conv2d is nice imo)
def get_unet_dev(pretrained_weights = None,input_size = (256,256,1)):
    inputs = Input(input_size)
